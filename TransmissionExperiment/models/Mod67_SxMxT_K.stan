...
parameters {
  matrix<lower=0.00000001,upper=0.1>[I,T] nu_bar_S;  	// varies by tree
  vector<lower=0.00000001,upper=0.1>[I] nu_bar_M;  	// no
  vector<lower=0.00000001,upper=5>[I] C_S;  		// no
  matrix<lower=0.00000001,upper=5>[I,T] C_M;  		// varies by tree
  vector<lower = 0, upper = 0.1>[T] mu_S;		// varies by tree
  real<lower = 0, upper = 0.1> mu_M;			// no
  real<lower = 0, upper = 5> muC_S;			// no
  vector<lower = 0, upper = 5>[T] muC_M;		// varies by tree
  real<lower = 0, upper = 4> sigma_M;
  real<lower = 0, upper = 5> sigmaC_S;
  vector<lower = 0, upper = 4>[T] sigma_S;
  vector<lower = 0, upper = 5>[T] sigmaC_M;
