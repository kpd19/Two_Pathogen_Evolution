...
parameters {
  vector<lower=0.00000001,upper=0.1>[I] nu_bar_S;  	// tree
  matrix<lower=0.00000001,upper=5>[I,T] C_S;  		// no
  real<lower = 0, upper = 0.1> mu_S;			// tree
  vector<lower = 0, upper = 5>[T] muC_S;		// no
  real<lower = 0, upper = 4> sigma_S;			// tree
  vector<lower = 0, upper = 5>[T] sigmaC_S;		// no
